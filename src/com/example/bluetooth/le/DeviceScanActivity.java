...
//			BluetoothGattService gattService = gatt.getService(UUID.fromString(SERVICE_UUID_TEST));
//			int type = gattService.getType();
//			Log.e(TAG, "----------------------------------------------------------");
//			Log.e(TAG, "-->service type:" + Utils.getServiceType(type));
//			Log.e(TAG, "-->includedServices size:" + gattService.getIncludedServices().size());
		...
		public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
			if (status == BluetoothGatt.GATT_SUCCESS) {
				Log.e(TAG, "onCharRead " + "  device nama: " + gatt.getDevice().getName() + "  char uuid: "
						+ characteristic.getUuid().toString() + "  value: " + byteArrayToString(characteristic.getValue()));
			}
		}
